...
namespace VkAudio.WPF.Collections
{
    /// Observable collection with ability to delay or suspend CollectionChanged notifications
    /// </summary>
    /// <typeparam name="T"></typeparam>
    [Serializable]
    public class ObservableCollectionDelayed<T> : Collection<T>, INotifyCollectionChanged, INotifyPropertyChanged, IDisposable
    {
        //-----------------------------------------------------
        //  Constants
        //-----------------------------------------------------
        ...
        /// <summary> 
        /// Initializes a new instance of ObservableCollectionDelayed that is empty and has default initial capacity. 
        /// </summary>
        public ObservableCollectionDelayed()
            : base()
        {
        }

        /// <summary>
        /// Initializes a new instance of the ObservableCollectionDelayed class
        /// that contains elements copied from the specified list 
        /// </summary>
        /// <param name="list">The list whose elements are copied to the new list.</param> 
        /// <remarks> 
        /// The elements are copied onto the ObservableCollectionDelayed in the
        /// same order they are read by the enumerator of the list. 
        /// </remarks>
        /// <exception cref="ArgumentNullException"> list is a null reference </exception>
        public ObservableCollectionDelayed(List<T> list)
        ...
        public ObservableCollectionDelayed(IEnumerable<T> collection)
        {
            if (collection == null)
        ...
        public ObservableCollectionDelayed(ObservableCollectionDelayed<T> parent, bool notify)
            : base(parent.Items)
        {
        ...
        /// <summary>
        /// Returns an instance of <see cref="ObservableCollectionDelayed{T}"/>
        ...
        /// </summary>
        /// <returns><see cref="ObservableCollectionDelayed{T}"/></returns>
        public ObservableCollectionDelayed<T> DelayNotifications()
        {
            return new ObservableCollectionDelayed<T>((null == _notifyInfo) ? this : _notifyInfo.RootCollection, true);
        }

        /// <summary>
        /// Returns a wrapper instance of an ObservableCollectionDelayed class.
        /// Calling methods of this instance will modify original collection
        /// but will not generate any notifications.
        /// </summary>
        /// <returns><see cref="ObservableCollectionDelayed{T}"/></returns>
        public ObservableCollectionDelayed<T> DisableNotifications()
        {
            return new ObservableCollectionDelayed<T>((null == _notifyInfo) ? this : _notifyInfo.RootCollection, false);
        }
        ...
        protected void CheckReentrancy()
        {
            ...
            {
                throw new InvalidOperationException("ObservableCollectionDelayed Reentrancy Not Allowed");
            }
        }
        ...
        private class NotificationInfo
        {
            ...
            public NotifyCollectionChangedEventHandler Initialize()
            {
                ...
                return (sender, args) =>
                {
                    ObservableCollectionDelayed<T> wrapper = sender as ObservableCollectionDelayed<T>;
                    Debug.Assert(null != wrapper, "Calling object must be ObservableCollectionDelayed<T>");
            ...
            public ObservableCollectionDelayed<T> RootCollection { get; set; }
